...
const carouselData: CarouselItem[] = [
  {
    ...
    description: 'We provide exceptional cleaning and floor care solutions which exceed our clients expectations.',
  ...
  },
  {
    ...
    description: 'Our team of experts ensures your facility stays spotless and hygienic.',
    buttonText: 'Contact Us',
    buttonLink: '/contactus',
  },
  {
      ...
      <div className="absolute top-[-13px] ">
        <div className='sm:ml-[-5px]'>
          ...
          <div className='ml-6 sm:ml-10 mt-[-86px] lg:mt-[-1]'>
            <svg xmlns="http://www.w3.org/2000/svg" width="250" height="86" viewBox="0 0 350 86" fill="none" className='ml-3'>
