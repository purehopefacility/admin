  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage({
          title: "SUBSCRIBED !",
          message: "you subscribe our newsletters",
          btn: "Ok",
        });
        setsub(true);
        setEmail("");
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 justify-around md:mb-10">
              ...
              <div className="space-y-4">
                ...
                <p className="md:w-[500px] font-light text-sm">
                  Pure Hope Facility Management is a professional commercial,
                  industrial cleaning and floorcare services specialist located
                  in Metropolitan Melbourne who provides exclusive and unique
                  facility management services to commercial, industrial and
                  retail premises.
                </p>
              </div>
              {/*from here*/}
              <div className="mt-2 md:mt-14">
                ...
                <form
                  ...
                  className="flex flex-col xl:flex-row gap-1"
                >
                  <input
                    type="email"
