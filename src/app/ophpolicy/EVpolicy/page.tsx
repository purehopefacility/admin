        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 justify-center md:mx-[13%] my-10 p-10 border-2 rounded-xl shadow-lg xl:mb-20">
          <div className="flex flex-col">
            ...
            <p className="mb-4 text-sm">
              ...
              environment by reducing waste, conserving resources, and promoting
            ...
            <ul className="list-disc list-inside mb-4 text-sm">
              ...
              <li>
                To educate and engage our employees, clients, and stakeholders
                on environmental issues and encourage sustainable practices.
              </li>
              <li>
          ...
          <div className="flex flex-col">
            ...
            <ul className="list-disc list-inside mb-4 text-sm">
              <li>
                Minimize waste generation through source reduction, recycling,
                and reuse initiatives
              </li>
              <li>
                Dispose of waste responsibly and in compliance with
            ...
            <ul className="list-disc list-inside mb-4 text-sm">
              <li>
                Implement measures to prevent pollution and minimize
            ...
            <ul className="list-disc list-inside mb-4 text-sm">
              <li>
                Source environmentally preferable products and services that
            ...
            <ul className="list-disc list-inside mb-4 text-sm">
              <li>
                Raise awareness among employees about environmental issues and
            ...
            <ul className="list-disc list-inside text-sm text-justify">
              ...
              operations and fostering a culture of sustainability, we aim to
              make a positive impact on the environment and contribute to a
              greener future.
            </ul>
          </div>
        </div>
