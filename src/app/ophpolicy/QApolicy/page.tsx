        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 justify-center md:mx-[13%] my-10 p-10 border-2 rounded-xl shadow-lg xl:mb-20">
          <div className="flex flex-col">
            ...
            <ul className="list-disc list-inside mb-4 text-sm">
              ...
              <li>
                Promote a culture of quality and continuous improvement across
                the organization.
              </li>
              <li>
                Facilitate training and development programs to enhance the
          ...
          <div className="flex flex-col">
            ...
            <ul className="list-disc list-inside mb-4 text-sm">
              <li>
                Implement and maintain efficient processes that ensure
                consistent service quality.
              </li>
              <li>
                Regularly review and optimize processes to enhance efficiency
                and effectiveness.
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside mb-4 text-sm">
              <li>
                ...
                measure service quality and client satisfaction.
              </li>
              <li>
                Conduct regular reviews and assessments to ensure targets are
            ...
            <ul className="list-disc list-inside mb-4 text-sm">
              ...
              as well as changes in industry standards and best practices, will
            ...
            <ul className="list-disc list-inside text-sm">
              ...
              and maintaining the highest standards of quality in all our
              services. By working together, we can ensure continuous
              improvement and deliver exceptional value to our clients.
            </ul>
          </div>
        </div>
      </div>
