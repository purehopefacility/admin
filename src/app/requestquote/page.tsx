...
export default function RequestQuote() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    setFormData({
      ...
      mobile: (e.currentTarget.elements.namedItem('mobile') as HTMLInputElement).value,
  ...
  const formContent = (
    <>
      <div className="mb-4">
        <label className="block text-sm text-white mb-1" htmlFor="name">Your Name</label>
        <input
          type="text"
          id="name"
      ...
      <div className="mb-4">
        <label className="block text-sm text-white mb-1" htmlFor="mobile">Mobile Number</label>
        <input
          type="text"
          id="mobile"
          name="mobile"
      ...
      <div className="mb-4">
        <label className="block text-sm text-white mb-1" htmlFor="email">Your Email</label>
        <input
          type="email"
          id="email"
          name="email"
      ...
      <div className="mb-4">
        <label className="block text-sm text-white mb-1" htmlFor="address">Address</label>
        <input
          type="text"
          id="address"
          name="address"
      ...
      <div className="mb-4">
        <label className="block text-sm text-white mb-1" htmlFor="message">Message</label>
        <textarea
          id="message"
          name="message"
    ...
    return (
      ...
      <div className="flex w-3/4 justify-center items-center  my-20">
        <div className="flex flex-col bg-[#003047] text-white rounded-3xl p-10 w-full">
          <h2 className="text-2xl text-[#219EBC] font-bold mb-4">Request a Quote</h2>
          <p className="text-sm mb-8">
            You've selected <span className="font-semibold">{selectedService}</span>. Please fill in the form below.
          </p>
      ...
      <div className="flex flex-col md:flex-row bg-[#003047] text-white rounded-3xl overflow-hidden">
        ...
        <div className="md:w-3/4 relative">
          ...
          <div className="absolute inset-0 bg-[#219EBC] bg-opacity-40 p-10 flex flex-col justify-center">
            <h2 className="text-2xl text-[#003047] font-bold mb-2">Request Quote</h2>
            <p className="text-sm">
              Send us a request to deliver a service quote to your email address.
            </p>
          </div>
        </div>
        ...
        <div className="w-full p-10 bg-[#003047]">
          <h3 className="text-sm mb-4 text-gray-400">Select Our Valuable Category</h3>
          <div className="space-y-3">
            ...
            <button
              onClick={() => handleButtonClick('Pure Hope Floor Care Services')}
