...
import { IconBrandFacebook, IconBrandInstagram, IconBrandTwitter, IconBrandLinkedin, IconBrandYoutube, IconBrandTiktok, IconBrandThreads, IconBrandX } from '@tabler/icons-react';
    ...
    <div className="flex flex-col">
      ...
      <div className="flex w-full items-end justify-center h-64 relative bg-cover bg-center bg-blue-700" 
        ...
        <div className="mb-5 text-[#219EBC] font-bold text-xl sm:text-2xl">
              <span className="text-[#003047]">Contact</span><span className="font-medium"> Us</span>
            </div>
        </div>
      </div>
